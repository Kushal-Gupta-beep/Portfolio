...
export const fallbackProjects: ProjectData[] = [
  ...
  },
  {
    ...
    description:
      'A Web3 gifting platform enabling secure ETH transfers with personalized messages — leveraging blockchain for transparent, global transactions. Earned Honorable Mention at Unfold 2023, India\'s second largest Web3 Hackathon.',
  ...
  },
  {
    ...
    category: 'AI / NLP',
    description:
      'An intelligent commit analysis system that evaluates GitHub commit histories using NLP pipelines — classifying commits by purpose and impact, generating repository-level metrics, and providing automated scoring to track development trends and code quality.',
  ...
  },
  {
    ...
    description:
      'A voice-driven shopping assistant that enables users to search, compare, and purchase products using natural language conversations — powered by speech-to-text, NLP pipelines, and an AI recommendation engine for personalized suggestions.',
